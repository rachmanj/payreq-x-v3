        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('cash-journals.in.move_all_tocart') }}" class="btn btn-sm btn-warning">Select All Documents to Cart</a>
                    @endif
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('cash-journals.in.remove_all_fromcart') }}" class="btn btn-sm btn-warning float-right mr-2">Remove All From Cart</a>
                    @endif
                </div>
                <div class="card-body">
    ...
    <div class="modal fade" id="create-journal">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="{{ route('cash-journals.in.store') }}" method="POST">
                    @csrf
...
<script>
  $(function () {
    ...
    $("#to_cart").DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ route('cash-journals.in.to_cart.data') }}',
      columns: [
    ...
    $("#in_cart").DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ route('cash-journals.in.in_cart.data') }}',
      columns: [
        {data: 'DT_RowIndex', orderable: false, searchable: false},
        {data: 'relization_no'},
        {data: 'receive_date'},
