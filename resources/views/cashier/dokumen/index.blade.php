  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header">
        <a href="#" class="text-dark">REKENING KORAN</a> | <a href="{{ route('cashier.dokumen.index', ['page' => 'pcbc']) }}">PCBC</a>
        @can('upload_dokumen')
          <button href="#" class="btn btn-xs btn-success float-right mr-2" data-toggle="modal" data-target="#modal-upload"><i class="fas fa-upload"></i> Upload RK</button>
        @endcan
      </div>  <!-- /.card-header -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <input type="month" name="periode" id="periode" class="form-control @error('periode') is-invalid @enderror">
              @error('periode')
