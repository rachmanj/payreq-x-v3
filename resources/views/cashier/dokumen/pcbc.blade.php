  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header">
        <a href="{{ route('cashier.dokumen.index') }}">Rekening Koran</a> | <a href="#" class="text-dark">PCBC</a>
        @can('upload_dokumen')
          <button href="#" class="btn btn-xs btn-success float-right mr-2" data-toggle="modal" data-target="#modal-upload"><i class="fas fa-upload"></i> Upload PCBC</button>
        @endcan
      </div>  <!-- /.card-header -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <input type="date" name="dokumen_date" id="dokumen_date" class="form-control @error('dokumen_date') is-invalid @enderror">
              @error('dokumen_date')
