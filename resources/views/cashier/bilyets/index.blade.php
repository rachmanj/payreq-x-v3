  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-header">
        ...
        @can('add_bilyet')
        <button href="#" class="btn btn-xs btn-warning float-right" data-toggle="modal" data-target="#modal-update-many"> Update Many</button>
          <button href="#" class="btn btn-xs btn-success float-right mr-2" data-toggle="modal" data-target="#modal-create"><i class="fas fa-plus"></i> Bilyet</button>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="date" name="bilyet_date" id="bilyet_date" class="form-control" value="{{ old('bilyet_date') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label>Select Bilyets</label>
                      <div class="select2-purple">
                        <select name="bilyet_ids[]" class="select2 form-control" multiple="multiple" data-dropdown-css-class="select2-purple" data-placeholder="Select Invoices" style="width: 100%;">
                          @foreach ($onhands as $item)
                            <option value="{{ $item->id }}">{{ $item->prefix . $item->nomor }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
