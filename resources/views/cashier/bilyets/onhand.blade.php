...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <x-bilyet-links page="onhand" />

            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ONHAND</h3>
                    @can('add_bilyet')
                        <button href="#" class="btn btn-xs btn-warning float-right" data-toggle="modal"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="bilyet_date" id="bilyet_date" class="form-control"
                                        value="{{ old('bilyet_date') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-purple">
                                        <select name="bilyet_ids[]" class="select2 form-control" multiple="multiple"
                                            data-dropdown-css-class="select2-purple" data-placeholder="Select Invoices"
                                            style="width: 100%;">
                                            @foreach ($onhands as $item)
                                                <option value="{{ $item->id }}">{{ $item->prefix . $item->nomor }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
