...
<div class="row">
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="number" class="form-control money-input" id="kertas_100rb" name="kertas_100rb" value="0"
                    min="0">
            </div>
            <div class="col-sm-4">
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="number" class="form-control money-input" id="kertas_5rb" name="kertas_5rb" value="0"
                    min="0">
            </div>
            <div class="col-sm-4">
    ...
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="number" class="form-control money-input" id="kertas_2rb" name="kertas_2rb" value="0"
                    min="0">
            </div>
            <div class="col-sm-4">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <input type="number" class="form-control money-input" id="kertas_1rb" name="kertas_1rb" value="0"
                    min="0">
            </div>
            <div class="col-sm-4">
