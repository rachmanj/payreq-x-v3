        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header text-center">
                    <div class="text-left">
                        <a href="{{ route('reports.document-creation.index', ['project' => '001H']) }}">Rekap</a>
                        | <a href="{{ route('reports.document-creation.by_user', ['project' => '001H']) }}">By
                            User</a> | <b>DATA</b>
                    </div>
    ...
    <script>
        $(function() {
            $("#document-data").DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('reports.document-creation.data', ['project' => '001H']) }}',
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
