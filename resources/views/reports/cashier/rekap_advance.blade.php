                ...
                <table class="table table-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="pb-0 text-right"><small><b>Rp.{{ $employee['total_user_advance'] }}</b></small></th>
                        ...
                        <tr>
                            ...
                            <th class="pb-0 text-right"><small><b>Rp.{{ $data['sum_all_amounts_by_project'] }}</b></small></th>
                        </tr>   
                    </tbody>
                </table>
            </div>
