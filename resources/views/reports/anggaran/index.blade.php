            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info small mb-3">
                        Inactivate Many applies only to checkboxes on the <strong>current DataTables page</strong>.
                        Switch pages or adjust search filters to include additional rows.
