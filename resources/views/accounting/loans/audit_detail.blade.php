            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('accounting.loans.audit.index') }}" class="btn btn-sm btn-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                <span
                                    class="info-box-icon bg-{{ $audit->action == 'created' ? 'success' : ($audit->action == 'deleted' ? 'danger' : 'warning') }}">
                                    <i
                    ...
                    @if ($audit->loan)
                        <div class="alert alert-info">
                            <h5><i class="fas fa-file-contract"></i> Loan Information</h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <p><strong>Loan Code:</strong> {{ $audit->loan->loan_code }}</p>
                                    <p><strong>Creditor:</strong> {{ $audit->loan->creditor->name ?? 'N/A' }}</p>
                                    <p><strong>Principal:</strong> IDR {{ number_format($audit->loan->principal, 2) }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>Description:</strong> {{ $audit->loan->description }}</p>
                                    <p><strong>Tenor:</strong> {{ $audit->loan->tenor }} months</p>
                                    <p><strong>Status:</strong> {{ ucfirst($audit->loan->status ?? 'N/A') }}</p>
                                </div>
                            </div>
                            <div class="mt-2">
                    ...
                    @else
                        <div class="alert alert-warning">
                            <i class="fas fa-exclamation-triangle"></i> This loan has been deleted.
                        </div>
                    @endif
