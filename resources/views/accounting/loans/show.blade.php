        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Kontrak: {{ $loan->loan_code }}</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#import-schedule-modal">
                        ...
                        @can('submit_sap_ap_invoice_installment')
                            <button type="button" class="btn btn-primary btn-sm" id="btn-bulk-submit-ap" disabled>
                                <i class="fas fa-file-invoice-dollar"></i> Bulk Submit AP
                            </button>
                        @endcan
                        <button type="button" class="btn btn-secondary btn-sm" id="btn-sync-paid">
                            <i class="fas fa-sync"></i> Sync Paid
                        </button>
                        <a href="{{ route('accounting.loans.index') }}" class="btn btn-sm btn-outline-primary ml-2">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <dd class="col-sm-9">: {{ $loan->status ? ucfirst($loan->status) : '-' }}</dd>
                    </div>
                </div>

                <div class="card-body table-responsive">
                    <table id="installments-table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                @can('submit_sap_ap_invoice_installment')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-save-split">Simpan</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="op-modal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-success" id="btn-confirm-op" disabled>Buat OP</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            <button type="button" class="btn btn-info btn-block" id="btn-import-preview">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btn-import-save" style="display:none;">
            ...
            $('#btn-bulk-submit-ap').on('click', function() {
                ...
                Swal.fire({
                    ...
                    fetch('{{ route('accounting.loans.installments.bulk_submit_sap_ap') }}', {
                        ...
                        html += '</ul>';
                        Swal.fire({ icon: 'info', title: 'Hasil Bulk Submit', html: html, width: 600 });
                        reloadTable();
                    });
                });
            });
            ...
            $('#btn-sync-paid').on('click', function() {
                Swal.fire({
                    ...
                    fetch('{{ route('accounting.loans.sync_paid') }}', {
                        ...
                        Swal.fire({ icon: 'info', title: 'Sync Selesai', text: `${synced} angsuran diperbarui.` });
                        reloadTable();
                    });
                });
            });
