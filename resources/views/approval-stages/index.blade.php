        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-sm btn-warning float-right mx-2" data-toggle="modal"
                        data-target="#modal-auto-create"> Auto Generate</button>
                    <button type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal"
                        data-target="#modal-create"><i class="fas fa-plus"></i> Stage</button>
                </div>
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="approver_id"
                                class="form-control select2bs4 @error('approver_id') is-invalid @enderror">
                                <option value="">-- select Approver --</option>
                                @foreach ($approvers as $approver)
                                    <option value="{{ $approver->id }}"
                                        {{ $approver->id == old('approver_id') ? 'selected' : '' }}>{{ $approver->name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('approver_id')
                            ...
                            <select name="project" class="form-control select2bs4 @error('project') is-invalid @enderror">
                                ...
                                @foreach ($projects as $project)
                                    <option value="{{ $project->code }}"
                                        {{ $project->id == old('project') ? 'selected' : '' }}>{{ $project->code }}</option>
                                @endforeach
                            </select>
                            @error('project')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="select2-purple">
                                <select name="departments[]" class="select2 form-control" multiple="multiple"
                                    data-dropdown-css-class="select2-purple" data-placeholder="Select departments"
                                    style="width: 100%;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="select2-purple">
                                <select name="documents[]" class="select2 form-control" multiple="multiple"
                                    data-dropdown-css-class="select2-purple" data-placeholder="Select documents"
                                    style="width: 100%;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="project" class="form-control select2bs4 @error('project') is-invalid @enderror">
                                ...
                                @foreach ($projects as $project)
                                    <option value="{{ $project->code }}"
                                        {{ $project->code == old('project') ? 'selected' : '' }}>{{ $project->code }}
                                    </option>
                                @endforeach
                            </select>
                            @error('project')
