        ...
        <div class="col-12">
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <a href="{{ route('user-payreqs.realizations.index') }}" class="btn btn-sm btn-primary float-right"><i
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <dd class="col-sm-8">: IDR {{ number_format($realization->realizationDetails->sum('amount'), 2) }}
                        </dd>
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title float-right">Payreq Amount: IDR
                        {{ number_format($realization->payreq->amount, 2) }} | Variance: IDR
                        {{ number_format($realization->payreq->amount - $realization_details->sum('amount'), 2) }}</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        <thead>
