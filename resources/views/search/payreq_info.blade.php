<dl class="row">
    ...
    @if ($payreq->submit_at)
        <dd class="col-sm-8">: {{ \Carbon\Carbon::parse($payreq->submit_at)->format('d M Y - H:i:s') }}
            wita</dd>
    @else
    ...
    @if ($payreq->approved_at)
        <dd class="col-sm-8">: {{ \Carbon\Carbon::parse($payreq->approved_at)->format('d M Y - H:i:s') }}
            wita</dd>
    @else
        <dd class="col-sm-8">: -</dd>
    @endif
    ...
    @if ($payreq->due_date)
        <dd class="col-sm-8">: {{ \Carbon\Carbon::parse($payreq->due_date)->format('d M Y - H:i:s') }}
            wita</dd>
    @else
        <dd class="col-sm-8">: -</dd>
    @endif
