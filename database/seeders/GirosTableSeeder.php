...
class GirosTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $giros = [
            ...
            [
                'acc_no' => '1490002222257',
                'acc_name' => 'Bank Mandiri IDR 257',
                'bank_id' => 1,
                'type' => 'giro',
                'curr' => 'IDR',
                'project' => '001H',
            ...
            [
                'acc_no' => '1490007118583',
                'acc_name' => 'Bank Mandiri IDR 583',
                'bank_id' => 1,
                'type' => 'giro',
                'curr' => 'IDR',
                'project' => '000H',
            ...
            [
                'acc_no' => '1270077977997',
                'acc_name' => 'Bank Mandiri IDR 997',
                'bank_id' => 1,
                'type' => 'giro',
                'curr' => 'IDR',
                'project' => '001H',
            ...
            [
                'acc_no' => '1541500096017C',
                'acc_name' => 'BPD Kaltim IDR 017C',
                'bank_id' => 2,
                'type' => 'giro',
                'curr' => 'IDR',
                'project' => '017C',
            ...
            [
                'acc_no' => '1480021645620',
                'acc_name' => 'Bank Mandiri IDR 620',
                'bank_id' => 1,
                'type' => 'giro',
                'curr' => 'IDR',
                'project' => '022C',
            ...
            [
                'acc_no' => '1480021077329',
                'acc_name' => 'Bank Mandiri IDR 329',
                'bank_id' => 1,
                'type' => 'giro',
                'curr' => 'IDR',
                'project' => '023C',
